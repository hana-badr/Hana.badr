...
Hero: Hana Ahmed the Warrior
Student ID: 16008356
GitHub account: hana-badr

A **Sand Kraken** bars the way near **the Giza plateau**. It only falls to
the exact blow.
...
4. Your warcry — copy the line below exactly, including punctuation:
   ...
   "By the Giza plateau, the Sand Kraken surrenders!"
